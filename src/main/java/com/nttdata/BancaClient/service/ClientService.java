package com.nttdata.BancaClient.service;
...
public class ClientService {
    ...
    public Mono<Client> findByIdentityNumber(String dni){
        log.debug("findByIdentityNumber executed {}", dni);
        return clientRepository.findByIdentityNumber(dni);
    }
